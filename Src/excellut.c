...
void rotatevector(int32_t x, int32_t y, int32_t degree) {
	...
	x1 = x * coscos(degree) - y * sinsin(degree) ;

	y1 = x * sinsin(degree) + y * coscos(degree) ;
